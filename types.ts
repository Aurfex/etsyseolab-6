export type Page = 'dashboard' | 'optimizer' | 'automation' | 'autopilot' | 'competitor' | 'settings' | 'reviews' | 'faq' | 'assistant' | 'gift_finder' | 'loyalty' | 'story_magazine' | 'add_product' | 'pricing';
